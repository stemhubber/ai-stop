...
const ERROR_RESPONSES = {
  TWILIO_INVALID_SID: [503, "Twilio is not configured correctly."],
  TWILIO_MISSING_TOKEN: [503, "Twilio is not configured correctly."],
  TWILIO_INVALID_API_KEY: [503, "Twilio is not configured correctly."],
  21608: [403, "This Twilio trial account can only message verified recipient numbers."],
  21610: [400, "This recipient has opted out of messages."],
  21614: [400, "The recipient number cannot receive this type of message."],
...
const FALLBACK_MESSAGE = {
  email: "The email provider could not send this message. Try again shortly.",
  sms: "The SMS provider could not send this message. Try again shortly.",
  whatsapp: "The WhatsApp provider could not send this message. Try again shortly.",
};
...
function respondToProviderError(res, channel, err) {
  ...
  const fallback = [500, FALLBACK_MESSAGE[channel] || "The provider could not send this message. Try again shortly."];
